 ...
 */
public final class AbortingTurf {

    private static final Logger LOG = LogManager.getLogger(AbortingTurf.class);

    /**
     * Privater Konstruktor.
     */
    private AbortingTurf() {
    }
    ...
    public static void main(final String[] args) {
        final Synch starterBox = new SimpleLatch();
        Thread thread;
        for (int i = 1; i <= 6; i++) {
